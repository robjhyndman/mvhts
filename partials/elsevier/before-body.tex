% Frontmatter partial from the quarto-journals/elsevier extension, modified to
% add the state to affiliations and to add the corresponding-author note only
% when an author is marked as corresponding.
